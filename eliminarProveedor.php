...
<body>
  ...
  require_once 'proveedores/servidor/datosProveedor.php';   
?>
   <table class="table">
     <thead>
       <tr>
     ...
     <tbody>
       <?php
           while($proveedor = $proveedores->fetch_assoc()) {
               ?>
               <tr data-idProveedor="<?php echo $proveedor["id"]; ?>">
                   <td><?php echo $proveedor["id"]; ?></td>
                   <td><?php echo $proveedor["nombre"]; ?></td>
                   <td><?php echo $proveedor["producto"]; ?></td>
                   <td><?php echo $proveedor["cif"]; ?></td>

                   <td><button data-idEliminar="<?php echo $proveedor["id"]; ?>" data-accion="eliminar" class="btn btn-primary">Eliminar</button></td>
                   <td><a href="editarProveedor.php?id=<?php echo $proveedor["id"]; ?>" class="btn btn-primary">Editar</a></td>
               </tr>    
               <?php
           }
       ?>
...
<script src="proveedores/js/eliminar.js" defer></script>
