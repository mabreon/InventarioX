...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="row">
            ...
            <div class="dot2"></div>
                   ...
                   <label for="trabajador">Seleccione el trabajador</label>
                    <br>
                    <select name="" id="trabajador" onchange="validarTrabajador()">
                        <option value="0">Seleccione</option>
                    <?php 
                        $query = $mysqli -> query ("SELECT * FROM trabajador");
                        while ($valores = mysqli_fetch_array($query)){
                            echo '<option value="'.$valores['id'].'">'.$valores['Nombre'].' '.$valores['Apellidos'].'</option>';
                        }
                    ...
                    <label for="fechaped">Fecha del pedido</label>
                    <input type="date" class="form-control" id="fechaped" onchange="validarFechaped()">
                    <div class="error bg-danger"></div>

                    <p></p>

                    <label for="fecharec">Fecha de recepcion</label>
                    <input type="date" class="form-control" id="fecharec" onchange="validarFecharec()">
                    <div class="error bg-danger"></div>
    ...
    <div class="modal fade" id="modal" data-backdrop="static">
            ...
            <script src="albaranes/js/validador.js" defer></script>
