...
require_once 'albaranes/servidor/datosAlbaran.php';   
?>
 <table class="table">
   <thead>
     <tr>
   ...
   <tbody>
     <?php
         while($albaran = $albaranes->fetch_assoc()) {
             ?>
             <tr data-idAlbaran="<?php echo $albaran["id"]; ?>">
                 <td><?php echo $albaran["id"]; ?></td>
                 <td><?php echo $albaran["trabajador"]; ?></td>
                 <td><?php echo $albaran["producto"]; ?></td>
                 <td><?php echo $albaran["proveedor"]; ?></td>
                 <td><?php echo $albaran["fechaped"]; ?></td>
                 <td><?php echo $albaran["fecharec"]; ?></td>

                 <td><button data-idEliminar="<?php echo $albaran["id"]; ?>" data-accion="eliminar" class="btn btn-primary">Eliminar</button></td>
             </tr>    
             <?php
         }
     ?>
...
<script src="albaranes/js/eliminar.js" defer></script>
...
crossorigin="anonymous"></script>
<link rel="stylesheet" href="albaranes/css/styles.css">
