...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <?php 
      ...
      require_once 'trabajadores/servidor/mostrarTrabajadorEditar.php';
    ?>

    <?php 
      $trabajador = $trabajador->fetch_assoc();
      if($trabajador){
    ?>       
       <div class="container mt-5">
        <div class="row">
            ...
            <div class="dot2"></div>
                    ...
                    <input type="text" class="form-control" id="nombre" onchange="validarNombre()" value="<?php echo $trabajador["nombre"] ?>">
                    <div class="error bg-danger"></div>
                    <p></p>
                    <label for="apellidos">Apellidos</label>
                    <input type="text" class="form-control" id="apellidos" onchange="validarApellidos()" value="<?php echo $trabajador["apellidos"] ?>">
                    <div class="error bg-danger"></div>    
                    <p></p>
                <button data-idEditar="<?php echo $trabajador["id"] ?>" data-accion="editar" class="btn btn-primary">Editar</button>
                <a href="eliminarTrabajador.php" class="btn btn-danger">Volver</a>
     ...
     <div class="modal-dialog" role="document">
       <div class="modal-content">
         ...
         <div class="modal-body">
           <p>¿Estás seguro de editar este Trabajador?</p>
         </div>
...
<script src="trabajadores/js/editarTrabajador.js"></script>
<script src="trabajadores/js/validadorEditar.js"></script>
