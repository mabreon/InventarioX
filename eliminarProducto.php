...
require_once 'productos/servidor/datosProducto.php';   
?>
 <table class="table">
   <thead>
     <tr>
   ...
   <tbody>
     <?php
         while($producto = $productos->fetch_assoc()) {
             ?>
             <tr data-idProducto="<?php echo $producto["id"]; ?>">
                 <td><?php echo $producto["id"]; ?></td>
                 <td><?php echo $producto["nombre"]; ?></td>
                 <td><?php echo $producto["tipo"]; ?></td>
                 <td><?php echo $producto["fechacad"]; ?></td>
                 <td><?php echo $producto["proveedor"]; ?></td>
                 <td><?php echo $producto["precio"]; ?></td>

                 <td><button data-idEliminar="<?php echo $producto["id"]; ?>" data-accion="eliminar" class="btn btn-primary">Eliminar</button></td>
                 <td><a href="editarProducto.php?id=<?php echo $producto["id"]; ?>" class="btn btn-primary">Editar</a></td>
             </tr>    
             <?php
         }
     ?>
...
<script src="productos/js/eliminar.js" defer></script>
